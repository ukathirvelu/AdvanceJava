...
public class HomeControllerTest {
	...
	public void normal() {
		...
		//assertThat(response.getBody()).isEqualToIgnoringWhitespace("browser");
	}
	...
	public void mobile() {
		...
		ResponseEntity<String> response = rest.exchange("/", HttpMethod.GET, new HttpEntity<>(requestHeaders), String.class);
		//assertThat(response.getBody()).isEqualToIgnoringWhitespace("mobile");
	}
	...
	public void tablet() {
		...
		ResponseEntity<String> response = rest.exchange("/", HttpMethod.GET, new HttpEntity<>(requestHeaders), String.class);
		//assertThat(response.getBody()).isEqualToIgnoringWhitespace("tablet");
	}
